      ...
      <section className="py-16 text-white bg-gradient-to-br from-primary-700 to-primary-900">
        <div className="container px-4 mx-auto">
          ...
          <p className="max-w-2xl text-xl text-primary-100">
            Kami siap membantu mewujudkan kebutuhan percetakan Anda. Hubungi kami melalui form atau kontak di bawah.
          </p>
        </div>
      </section>
        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 gap-8 mb-12 lg:grid-cols-3">
            ...
            <div className="p-6 card">
              ...
              <p className="mb-2 text-gray-600">
                <a href="mailto:info@percetakancodot.com" className="hover:text-primary-600">
                  info@percetakancodot.com
                </a>
              </p>
              <p className="text-gray-600">
                <a href="mailto:order@percetakancodot.com" className="hover:text-primary-600">
                  order@percetakancodot.com
                </a>
              </p>
            </div>
          </div>
            ...
            <div className="p-8 card">
              ...
              <div className="p-4 mt-6 rounded-lg bg-primary-50">
                <p className="text-sm text-primary-800">
                  <strong>Catatan:</strong> Untuk kebutuhan mendesak, silakan hubungi kami melalui WhatsApp 
                  di luar jam operasional. Kami akan merespons secepat mungkin.
                </p>
              </div>
            </div>
          </div>
