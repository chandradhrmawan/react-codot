...
const Kontak = () => {
  return (
    <div>
      ...
      <section className="py-16 text-white bg-gradient-to-br from-primary-700 to-primary-900">
        <div className="container px-4 mx-auto">
          ...
          <p className="max-w-2xl text-xl text-primary-100">
            Kami siap membantu mewujudkan kebutuhan percetakan Anda. Hubungi
            kami melalui form atau kontak di bawah.
          </p>
        </div>
      </section>
        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 gap-8 mb-12 lg:grid-cols-3">
            ...
            <div className="p-6 card">
              ...
              <h3 className="mb-2 text-lg font-bold font-heading">Alamat</h3>
              <p className="text-gray-600">
                Jl. Lurus Gg. 3 No.12 10, RT.8/RW.6, Kb. Bawang, Kec. Tj. Priok,
                Jkt Utara, Daerah Khusus Ibukota Jakarta 14320
              </p>
            </div>
            ...
            <div className="p-6 card">
              ...
              <h3 className="mb-2 text-lg font-bold font-heading">Telepon</h3>
              <p className="mb-2 text-gray-600">
                <a href="tel:+628567827236" className="hover:text-primary-600">
                  08567827236
                </a>
              </p>
              <p className="text-gray-600">
            ...
            <div className="p-6 card">
              ...
              <h3 className="mb-2 text-lg font-bold font-heading">Email</h3>
              <p className="mb-2 text-gray-600">
                <a
                  href="mailto:info@darmaciptamedia.com"
                  className="hover:text-primary-600"
                >
                  info@darmaciptamedia.com
                </a>
              </p>
              <p className="text-gray-600">
                <a
                  href="mailto:order@darmaciptamedia.com"
                  className="hover:text-primary-600"
                >
                  order@darmaciptamedia.com
                </a>
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-center section-title">Jam Operasional</h2>
            <div className="p-8 card">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pb-3 border-b">
                  ...
                  <span className="text-gray-600">08:00 - 14:00 WIB</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="font-semibold">Minggu & Hari Libur</span>
              ...
              <div className="p-4 mt-6 rounded-lg bg-primary-50">
                <p className="text-sm text-primary-800">
                  <strong>Catatan:</strong> Untuk kebutuhan mendesak, silakan
                  hubungi kami melalui WhatsApp di luar jam operasional. Kami
      ...
      <section className="py-16 bg-gray-50">
        <div className="container px-4 mx-auto">
          <h2 className="mb-8 text-center section-title">Lokasi Kami</h2>
          <div className="overflow-hidden shadow-lg rounded-xl">
            <iframe
              ...
              title="Lokasi Percetakan"
            ></iframe>
          </div>
          <div className="mt-4 text-center">
            <a
              href="https://maps.app.goo.gl/xvskM8w6LtZ5gbRg8"
              target="_blank"
      ...
      <section className="py-12 bg-primary-600">
        <div className="container px-4 mx-auto">
          <div className="text-center">
            <h3 className="mb-6 text-2xl font-bold text-white font-heading">
              Butuh Respons Cepat?
            </h3>
