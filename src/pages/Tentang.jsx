  ...
  const values = [
    {
      title: "Kualitas",
      description:
        "Komitmen pada standar kualitas tertinggi di setiap hasil produksi",
      ...
      <section className="py-16 text-white bg-gradient-to-br from-primary-700 to-primary-900">
        <div className="container px-4 mx-auto">
          ...
          <p className="max-w-2xl text-xl text-primary-100">
            Mengenal lebih dekat perjalanan dan komitmen kami dalam industri
            percetakan
          </p>
        </div>
      </section>
          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  <strong>Darma Cipta Media</strong> didirikan pada tahun 2013
                  dengan visi menjadi mitra terpercaya dalam solusi percetakan
                  berkualitas tinggi di Indonesia. Berawal dari sebuah workshop
                  kecil dengan 2 mesin cetak, kini kami telah berkembang menjadi
                  salah satu percetakan terkemuka dengan fasilitas modern dan
                  tim profesional.
                </p>
                <p>
                  Selama lebih dari 10 tahun, kami telah melayani ratusan klien
                  dari berbagai industri, mulai dari UMKM hingga perusahaan
                  multinasional. Kepercayaan mereka adalah aset terbesar yang
                  terus mendorong kami untuk memberikan yang terbaik.
                </p>
                <p>
                  Kami berkomitmen untuk terus berinovasi dan mengadopsi
                  teknologi terkini dalam industri percetakan, sambil tetap
                  menjaga nilai-nilai kualitas, integritas, dan pelayanan prima
                  yang menjadi fondasi perusahaan kami.
                </p>
              </div>
            </div>
            <div className="flex items-center justify-center bg-white-200 rounded-xl h-96">
        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="p-8 card">
              ...
              <h2 className="mb-4 text-2xl font-bold font-heading text-navy-900">
                Visi
              </h2>
              <p className="text-gray-700">
                Menjadi perusahaan percetakan terdepan di Indonesia yang dikenal
                dengan kualitas premium, inovasi berkelanjutan, dan pelayanan
                terbaik yang memberikan nilai maksimal bagi setiap klien kami.
              </p>
            </div>
            ...
            <div className="p-8 card">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>
                    Menyediakan produk percetakan berkualitas tinggi dengan
                    harga kompetitif
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2 text-accent-600">•</span>
                  <span>
                    Memberikan pelayanan prima dan responsif kepada setiap
                    pelanggan
                  </span>
                </li>
                <li className="flex items-start">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="p-6 text-center card">
              ...
              <p className="text-gray-600">
                Digital & offset printing teknologi terkini
              </p>
            </div>
            ...
            <div className="p-6 text-center card">
              ...
              <p className="text-gray-600">
                Pengecekan kualitas di setiap tahap
              </p>
            </div>
            ...
            <div className="p-6 text-center card">
              ...
              <p className="text-gray-600">
                Workstation profesional untuk desainer
              </p>
            </div>
          </div>
        </div>
