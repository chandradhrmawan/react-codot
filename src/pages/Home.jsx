      ...
      <section className="py-16 bg-white">
        <div className="container px-4 mx-auto">
          <div className="mb-12 text-center">
            <h2 className="section-title">Lihat Proses Kerja Kami</h2>
            <p className="section-subtitle">
              Teknologi modern dan tim profesional untuk hasil terbaik
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <iframe
                ...
                src="https://www.youtube-nocookie.com/embed/9LSurMYPK60"
                title="Video Proses Kerja"
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Menggunakan material dan teknologi terbaik
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Garansi pengerjaan sesuai deadline
              </p>
            </div>
