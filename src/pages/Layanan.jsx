  ...
  const mainServices = [
    {
      ...
      description:
        "Teknologi cetak tradisional yang ideal untuk volume besar dengan kualitas konsisten dan biaya efisien.",
    ...
    },
    {
      ...
      description:
        "Solusi cetak modern untuk order kecil hingga menengah dengan hasil cepat dan fleksibel.",
    ...
    },
    {
      ...
      description:
        "Spesialisasi pembuatan kalender custom untuk promosi perusahaan atau hadiah.",
      ...
      features: [
        ...
        "Art paper/ivory premium",
        "finishing  Laminating, spot ultra violet.",
        "Embos dan Debos logo",
      ],
    },
    {
      title: "Cetak Brosur & Flyer",
      description:
        "Media promosi efektif untuk marketing dan branding bisnis Anda.",
    ...
    },
    {
      ...
      description:
        "Buku agenda custom dengan logo perusahaan untuk souvenir atau merchandise.",
    ...
    },
    {
      title: "Desain Grafis",
      description:
        "Layanan desain profesional untuk berbagai kebutuhan percetakan Anda.",
  ...
  const additionalServices = [
    {
      ...
      description:
        "Diskusi langsung dengan tim untuk menentukan solusi terbaik",
    },
    {
      title: "Proof Digital",
      ...
      <section className="py-16 text-white bg-gradient-to-br from-primary-700 to-primary-900">
        <div className="container px-4 mx-auto">
          ...
          <p className="max-w-2xl text-xl text-primary-100">
            Solusi percetakan lengkap dengan teknologi modern dan tim
            berpengalaman
          </p>
        </div>
      </section>
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {additionalServices.map((service, index) => (
              <div
                key={index}
                className="p-6 text-center transition-shadow bg-white rounded-lg shadow-md hover:shadow-xl"
              >
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
              {[
                ...
                },
                {
                  step: "02",
                  title: "Penawaran",
                  desc: "Estimasi harga & timeline",
                },
                {
                  step: "03",
                  title: "Produksi",
                  desc: "Proses cetak & quality control",
                },
                {
                  step: "04",
                  title: "Pengiriman",
                  desc: "Pengiriman produk jadi",
                },
              ].map((item, index) => (
                <div key={index} className="text-center">
                  <div className="flex items-center justify-center w-20 h-20 mx-auto mb-4 text-2xl font-bold text-white rounded-full bg-primary-600">
                    {item.step}
                  </div>
                  <h3 className="mb-2 text-lg font-bold font-heading">
                    {item.title}
